...
namespace Academico2025.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Telefone,Email")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Telefone,Email")] Departamento departamento)
        {
